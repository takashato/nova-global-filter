<template>
  <tr class="group">
    ...
    >
      <h2 class="text-base text-gray-500 truncate" v-html="row.title"></h2>
      <p class="text-gray-400 text-xs truncate" v-html="row.subtitle"></p>
    </td>
...
<script>
import MetricTableRow from "@/components/Metrics/MetricTableRow";

export default {
  mixins: [MetricTableRow],
  name: "MetricTableRow"
};
</script>
